...
# The main function get the number of hours worked and
...
def main():
    ...
    hours_worked = float(input('Enter the numbers of hours worked: '))
...
def calc_pay_with_OT(hours, rate):
    ...
    print('This gross pay is $', format(gross_pay, ',.2f'), sep='')

# The calc_regular_pay function calculates pay with
# no obertime. It accepts the hours worked and the hourly
# pay rate as arguments. The gross pay is displayed.
def calc_tegular_pay(hours, rate):
    # Calculate the gross pay.
