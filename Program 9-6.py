...
def get_login_name(first, last, idnumber):
    ...
    # If the name si less than 3 characters, the
...
# and argument and return either true or false to
...
def valid_password(password):
    ...
    if len(password) >= 7:
        ...
        # appreciate flag when a required
        # character is found.
        for ch in password:
            if ch.isupper():
                has_uppercase = True
            ...
            if ch.isdigit():
                has_digit = True
        # Determine wheather all of the requirements
