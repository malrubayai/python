...
class CellPhone:
    ...
    # The __init__ methos initializes the attributes.
    ...
    # The set_ manufact methos accepts an argument for
    # the phone's manufacturer.

    def set_manufact(self, manufact):
        self.__manufact = manufact

    # The set_model methos accepts an argument for
    ...
    # The get_manufact methos returns the
